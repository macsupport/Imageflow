 ...
 *
 *Modifications by DrMikey 9/2011
 *--------------------------------------------------------------------------*/
/* 
 * ============================================================
...
*/
    ...
    _init: function () {
        ...
        var scrollbar = this.Container.getChildrenByClassName('slider')[0];
        if (scrollbar) {
            this.Scrollbar = new ContentFlowGUIElement(this, scrollbar);
            var slider = this.Scrollbar.getChildrenByClassName('ui-slider-handle')[0];
            if (slider) {
    ...
    _initGUI: function () {
        ...
        var divs = this.Container.getElementsByTagName('button');
